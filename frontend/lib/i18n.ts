...
export const copy = {
  en: {
    ...
    data: {
      dataCenter: "Data Management Center",
      title: "Add customer data",
      description: "Upload CSV or Excel data. The platform detects columns, validates quality and adds the dataset to the active pipeline automatically.",
      ...
      retrained: "The active datasets were retrained successfully.",
      ...
      autoMapped: "Schema auto-mapped with high confidence.",
      reviewNeeded: "Review needed: some fields need confirmation.",
      ...
      feedsDashboard: "feeding the dashboard",
      pipelineInputs: "Pipeline inputs",
      pipelineDescription: "Only active datasets feed the dashboard, RFM segmentation, clustering, simulator and insights.",
      datasets: "Datasets",
      datasetLibrary: "Dataset library",
      datasetLibraryTip: "Deactivate a dataset to remove its customers from the analysis without deleting the file.",
      ...
      disable: "Deactivate",
      delete: "Delete",
      datasetEnabled: "Dataset activated. Metrics were recalculated.",
      datasetDisabled: "Dataset deactivated. Metrics were recalculated.",
      datasetDeleted: "Dataset deleted. Metrics were recalculated.",
      columnsDetected: "columns detected",
      previewRows: "preview rows",
      close: "Close",
      loadError: "Could not load data status.",
      schemaFailed: "Schema inference failed.",
      updateFailed: "Data update failed.",
    },
    tooltips: {
      clustering: "Clustering groups customers with similar buying behavior so marketing teams can target them differently.",
      silhouette: "Silhouette indicates how separated the clusters are. Higher usually means cleaner, easier-to-explain groups.",
      pca: "PCA compresses many customer signals into two dimensions so the clusters can be plotted visually.",
      churn: "Churn risk means a customer looks likely to stop buying based on inactivity and past behavior.",
    },
    insights: {
      action: "Action",
      impact: "Impact",
  ...
  es: {
    ...
    data: {
      dataCenter: "Centro de Gestion de Datos",
      title: "Anadir datos de clientes",
      description: "Sube CSV o Excel. La plataforma detecta columnas, valida calidad y anade el dataset al pipeline activo automaticamente.",
      selectFile: "Seleccionar archivo",
      retrain: "Reentrenar despues de subir",
      upload: "Subir dataset",
      detecting: "Detectando esquema",
      uploading: "Subiendo",
      retrainOnly: "Reentrenar dataset actual",
      retrained: "Los datasets activos se han reentrenado correctamente.",
      ...
      autoMapped: "Esquema auto-mapeado con alta confianza.",
      reviewNeeded: "Requiere revision: algunos campos necesitan confirmacion.",
      ...
      advancedMapping: "Mapping avanzado",
      activeDatasets: "Datasets activos",
      totalDatasets: "datasets totales",
      activeCustomers: "Clientes activos",
      activeRows: "Filas activas",
      feedsDashboard: "alimentan el dashboard",
      pipelineInputs: "Datos que alimentan el pipeline",
      pipelineDescription: "Solo los datasets activos alimentan dashboard, segmentacion RFM, clustering, simulador e insights.",
      datasets: "Datasets",
      datasetLibrary: "Biblioteca de datasets",
      datasetLibraryTip: "Desactiva un dataset para quitar sus clientes del analisis sin borrar el archivo.",
      noDatasets: "Todavia no hay datasets subidos.",
      active: "Activo",
      inactive: "Inactivo",
      enable: "Activar",
      disable: "Desactivar",
      delete: "Eliminar",
      datasetEnabled: "Dataset activado. Las metricas se han recalculado.",
      datasetDisabled: "Dataset desactivado. Las metricas se han recalculado.",
      datasetDeleted: "Dataset eliminado. Las metricas se han recalculado.",
      columnsDetected: "columnas detectadas",
      previewRows: "filas de preview",
      close: "Cerrar",
      loadError: "No se pudo cargar el estado de datos.",
      schemaFailed: "Fallo la inferencia del esquema.",
      updateFailed: "No se pudo actualizar datos.",
    },
    tooltips: {
      clustering: "El clustering agrupa clientes con comportamientos de compra similares para poder activar campanas distintas.",
      silhouette: "Silhouette indica si los clusters estan bien separados. Cuanto mas alto, mas claros suelen ser los grupos.",
      pca: "PCA reduce muchas senales de cliente a dos ejes para poder visualizar los clusters en un grafico.",
      churn: "Riesgo de churn significa que un cliente parece propenso a dejar de comprar por inactividad y comportamiento historico.",
    },
    insights: {
      action: "Accion",
      impact: "Impacto",
