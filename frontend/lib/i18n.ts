...
export const copy = {
  en: {
    ...
    data: {
      ...
      description: "Upload a CSV with the Online Retail schema. The backend can retrain the full pipeline and refresh the dashboard automatically.",
  ...
  es: {
    ...
    data: {
      ...
      description: "Sube un CSV con el esquema de Online Retail. El backend puede reentrenar el pipeline completo y refrescar el dashboard automaticamente.",
